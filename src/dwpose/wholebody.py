...
ModelDataPathPrefix = Path("/home/vton/westchaevi/Tunnel/pretrained_weights")
...
class Wholebody:
    def __init__(self, device="cpu"):
        ...
        self.session_det = ort.InferenceSession(
            path_or_bytes=str(onnx_det), providers=providers
        )
        self.session_pose = ort.InferenceSession(
            path_or_bytes=str(onnx_pose), providers=providers
        )
